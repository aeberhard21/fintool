...
//             let cid = _db
//                 .get_category_id(_aid, category.clone().category.name)
//                 .unwrap();
...
//                 ignore = Confirm::new(prompt.as_str())
//                     .with_default(false)
//                     .prompt()
//                     .unwrap();
//             }
...
//         let add_more = Confirm::new("Add additional budget categories?")
//             .with_default(false)
//             .prompt()
//             .unwrap();
//         if add_more {
...
//                     delete = Confirm::new(prompt.as_str())
//                         .with_default(false)
//                         .prompt()
//                         .unwrap();
//                 }
//                 if !delete {
//                     _db.update_budget_item(
//                         _aid,
//                         BudgetItem {
//                             category_id: cid,
//                             value: value,
