...
impl HasVariableAccountContext for InvestmentAccountManager {
...
impl VariableAccount for InvestmentAccountManager {}

impl LedgerOps for InvestmentAccountManager {
    fn modify(&mut self, selected_record: LedgerRecord) -> Option<LedgerRecord> {
        self.modify_variable(selected_record)
    }
}

impl InterestBearingLedger for InvestmentAccountManager {}

impl VariableLedger for InvestmentAccountManager {}

impl InterestBearingFixedAccount for InvestmentAccountManager {}

impl FixedAccount for InvestmentAccountManager {}

impl Valuable for InvestmentAccountManager {
...
impl VariableGrowth for InvestmentAccountManager {}

impl AccountFileIO for InvestmentAccountManager {
    fn import(&self) {
...
impl VariableAccountFileIO for InvestmentAccountManager {}
        ...
        loop {
            ...
            match modify_choice {
                "Ledger" => loop {
                    ...
                    <InvestmentAccountManager as LedgerOps>::modify(self, selected_record);
                ...
                if positions_wrapped.is_some() {
                    ...
                    for position in positions {
                        println!(
                            ...
                            get_costbasis(&self.ctx, &self.vctx, position.0)
                        );
                    }
                } else {
                    println!("\nNo positions found!");
