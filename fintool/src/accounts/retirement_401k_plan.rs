...
impl HasVariableAccountContext for Retirement401kPlan {
...
impl VariableAccount for Retirement401kPlan {}

impl LedgerOps for Retirement401kPlan {
    fn modify(&mut self, selected_record: LedgerRecord) -> Option<LedgerRecord> {
        self.modify_variable(selected_record)
    }
}

impl InterestBearingLedger for Retirement401kPlan {}

impl VariableLedger for Retirement401kPlan {}

impl InterestBearingFixedAccount for Retirement401kPlan {}

impl FixedAccount for Retirement401kPlan {}

impl Valuable for Retirement401kPlan {
...
impl VariableGrowth for Retirement401kPlan {}

impl ValueLimited for Retirement401kPlan {
    fn account_limit(&self) -> f32 {
        let acct = self.ctx.db.get_401k(self.ctx.uid, self.ctx.aid).unwrap();
...
impl AccountFileIO for Retirement401kPlan {
    fn import(&self) {
...
impl VariableAccountFileIO for Retirement401kPlan {}
        ...
        loop {
            ...
            match modify_choice {
                ...
                "Ledger" => loop {
                    ...
                    <Retirement401kPlan as LedgerOps>::modify(self, selected_record);
