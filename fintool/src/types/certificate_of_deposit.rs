...
impl DbConn {
    ...
    pub fn add_certificate_of_deposit(&self, uid : u32, aid: u32, info: CertificateOfDepositInfo) -> Result<u32> {
    ...
    pub fn update_cd_maturity_date(&self, uid : u32, aid: u32, new_maturity_date : String) -> Result<String> {
    ...
    pub fn get_certificate_of_deposit(&self, uid : u32, aid : u32) -> Result<CertificateOfDepositRecord, rusqlite::Error> { 
